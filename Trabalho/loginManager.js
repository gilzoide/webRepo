...
loginManager.createDefault = function () {
	var padrao = new User ('Gil Barbosa Reis', 'Zumbi', 'senha', 'imagens/cavalo.png');
	this.usuarios.Zumbi = padrao;
	this.setLogged (padrao);
...
/// Salva todos usuários no localStorage, guardar pra próxima e talz
loginManager.salvaUsuarios = function () {
	sessionStorage.usuarios = JSON.stringify (this.usuarios);
}
